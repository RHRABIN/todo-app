...
import logo2 from "../assests/TB Letter Heart.png";
    ...
    <div>
      ...
      <div className="flex items-center flex-shrink-0 w-full h-16  bg-opacity-75 justify-between flex-col sm:flex-row mb-28 sm:mb-0">
        <div className="flex gap-4 items-center">
          <h1 className="text-[2rem] text-[#f97316] font-bold">TODO APP</h1>
        </div>
        ...
        <div className=" gap-2 items-center hidden sm:flex">
          <button className="flex items-center justify-center w-12 h-12 ml-auto overflow-hidden rounded-full cursor-pointer">
